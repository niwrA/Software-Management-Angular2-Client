  ...
  changeName(): void {
    if (this.previousEpicElement !== undefined) {
      if (this.epicElement.name !== this.previousEpicElement.name) {
        const renameCommand = new RenameEpicElementCommand(this.epicElement, this.previousEpicElement.name, this.design.guid);
  ...
  changeDescription(): void {
    if (this.previousEpicElement !== undefined) {
      if (this.epicElement.description !== this.previousEpicElement.description) {
        const command = new ChangeDescriptionOfEpicElementCommand(this.epicElement, this.design.guid);
